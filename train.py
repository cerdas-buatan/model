...
class Seq2Seq:
    ...
    def build_model(self):
        ...
        self.model.compile(optimizer=Adam(), loss=sparse_softmax_cross_entropy)
    ...
    def train(self, X_train, y_train, batch_size, epochs):
        ...
        # Train the model
        self.model.fit([X_train, y_train[:, :]], y_train[:, :], batch_size=batch_size, epochs=epochs, validation_split=0.9)
